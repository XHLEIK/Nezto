...
const StainRemovalPage = () => {
  ...
  const [selectedStain, setSelectedStain] = useState("basic");
  ...
  const serviceDetails = {
    ...
    icon: "fas fa-eraser",
    price: 10.99,
    description: "Specialized treatment for tough stains on all fabrics",
    longDescription: "Our stain removal experts tackle even the most stubborn stains on all types of fabrics. We use specialized techniques and eco-friendly products to target specific stains without damaging the fabric integrity or color.",
    features: [
      "Expert treatment for all stain types",
      "Specialized products for different fabrics",
      "Food, oil, ink, blood, and wine stain removal",
      "Color-safe treatments",
      "Same-day service available for urgent needs"
    ],
    priceOptions: [
      { id: "basic", name: "Basic Stain Treatment", price: 10.99, unit: "per stain" },
      { id: "advanced", name: "Advanced Stain Treatment", price: 39.99, unit: "per stain" },
      { id: "multiple", name: "Multiple Stains (3-5)", price: 69.99, unit: "per garment" },
      { id: "extensive", name: "Extensive Stain Damage", price: 89.99, unit: "per garment" },
      { id: "delicate", name: "Delicate Fabric Premium", price: 149.99, unit: "additional" }
    ],
    process: [
      { name: "Inspection", description: "Thorough assessment of the stain type and fabric", icon: "fas fa-search" },
      { name: "Pre-treatment", description: "Application of specialized solution based on stain type", icon: "fas fa-vial" },
      { name: "Treatment", description: "Professional stain removal techniques", icon: "fas fa-eraser" },
      { name: "Finishing", description: "Neutralizing treatment and fabric care", icon: "fas fa-check" }
    ],
    testimonials: [
      { name: "Rahul K.", rating: 4.9, comment: "They removed a red wine stain that I thought had ruined my favorite shirt!" },
      { name: "Sanya M.", rating: 4.8, comment: "Amazing service for my kid's school uniform. The ink stains are completely gone." }
    ],
    category: "premium",
    rating: 4.9
  };
  ...
  const handleBookService = () => {
    try {
      navigate('/service-payment', { state: { service: { ...serviceDetails, quantity: quantity, selectedOption: selectedStain, totalPrice: calculatePrice() } } });
    } catch (err) {
  ...
  const calculatePrice = () => {
    const item = serviceDetails.priceOptions.find(option => option.id === selectedStain);
    ...
    <div className="container-fluid p-0 pb-5" style={{ backgroundColor: "#f8f9fa", minHeight: "100vh" }}>
      ...
      <div className="mx-3 p-4 rounded shadow-sm" style={{ 
        ...
        <div className="row g-3">
          <div className="col-md-6">
            <label className="form-label">Stain Type</label>
            <select 
              className="form-select" 
              value={selectedStain}
              onChange={(e) => setSelectedStain(e.target.value)}
      ...
      <div className="px-3 mt-4 mb-4">
        <div className="p-3 rounded" style={{ 
          ...
          <p className="mb-0">Results may vary depending on stain type, fabric, and age of the stain. Some stains might require multiple treatments for complete removal.</p>
        </div>
      </div>
