...
const DryCleaningPage = () => {
  ...
  const serviceDetails = {
    ...
    icon: "fas fa-tshirt",
    price: 15.99,
    description: "Professional eco-friendly cleaning for your delicate garments",
    longDescription: "Our premium dry cleaning service uses eco-friendly solvents to clean items that cannot be washed with water. Ideal for suits, formal wear, silk, wool, and delicate fabrics that require special care.",
    features: [
      "Gentle cleaning for delicate fabrics",
      "Stain removal specialists",
      "Eco-friendly cleaning agents",
      "Garment inspection before and after cleaning",
      "Professional pressing and finishing"
    ],
    priceOptions: [
      { id: "shirts", name: "Shirts/Tops", price: 15.99, unit: "per piece" },
      { id: "pants", name: "Pants/Trousers", price: 17.99, unit: "per piece" },
      { id: "suits", name: "Suits (2 piece)", price: 29.99, unit: "per set" },
      { id: "dresses", name: "Dresses", price: 24.99, unit: "per piece" },
      { id: "winterwear", name: "Winter Wear", price: 29.99, unit: "per piece" }
    ],
    process: [
      { name: "Inspection", description: "Detailed inspection of your garments to identify stains and special care requirements", icon: "fas fa-search" },
      { name: "Pre-Treatment", description: "Targeted spot treatment for stains and soiled areas", icon: "fas fa-spray-can" },
      { name: "Cleaning", description: "Gentle cleaning with eco-friendly solvents", icon: "fas fa-tshirt" },
      { name: "Pressing", description: "Professional finishing and pressing", icon: "fas fa-iron" },
      { name: "Quality Check", description: "Final inspection to ensure top-quality results", icon: "fas fa-check-circle" }
    ],
    testimonials: [
      { name: "Rahul K.", rating: 5, comment: "The stain removal was outstanding! My silk shirt looks brand new again." },
      { name: "Priya M.", rating: 5, comment: "I trust them with all my designer wear. Professional service every time." }
    ],
    category: "daily",
    rating: 4.7
  };
            ...
            <table className="table table-hover">
              ...
              <tbody>
                {serviceDetails.priceOptions.map((option, index) => (
                  <tr key={index}>
                    <td>{option.name}</td>
                    <td className="fw-bold text-primary">₹{option.price}</td>
                    <td>{option.unit}</td>
                  </tr>
                ))}
              </tbody>
