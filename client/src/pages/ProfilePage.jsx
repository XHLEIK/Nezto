...
const MenuItem = ({ title, subtitle, icon }) => {
  return (
    <div className="flex items-center py-3 border-b border-teal-200">
      ...
      <main className="flex-1 p-4 my-20 flex flex-col gap-4">
        ...
        <div className="flex flex-col">
          ...
          <MenuItem
            ...
            subtitle="Save Your Other Locations"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
          ...
          <MenuItem
            ...
            subtitle="Save Your Payment Method For Faster Billing"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <MenuItem
            title="Notifications"
            subtitle="Get All the Updates Here"
            icon={
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex justify-center mt-4">
          <button className="px-8 py-2 bg-white text-red-500 border border-red-500 rounded-full font-medium">
            Log Out
          </button>
        </div>
      </main>
